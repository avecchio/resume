...
\item Tools – Mercurial, Chef, Git, Vim, Vagrant,\LaTeX, Wireshark, Nmap, Autodesk Inventor %, Swig, PointCloud, Redhawk, Android
\end{itemize}
...
\item Organizations - Green Engineering Organization, WKUF, %Computing Profession
